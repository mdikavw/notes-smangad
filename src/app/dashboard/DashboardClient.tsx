        ...
        <div className='flex flex-col min-h-screen items-start justify-start gap-8 w-full'>
            ...
            <div className='w-full flex gap-8'>
                        ...
                        <table className='w-full border-collapse'>
                            ...
                            <tbody>
                                <tr className='border-t border-slate-50'>
                                    <td className='p-3 font-medium'>Rapat Koordinasi Guru</td>
                                    <td className='p-3 text-sm text-slate-600'>
                                        Mengikuti rapat koordinasi bersama kepala sekolah dan guru.
                                    </td>
                    ...
                    <div className='flex flex-col gap-4 '>
                        ...
                        <div className='flex flex-col gap-4 font-medium'>
                            {activitiesHistory.map(a => (
                                <div key={a.name} className='rounded-xl bg-[#d9dcf2] p-4 flex gap-8'>
                ...
                <div className='min-w-66.5 flex flex-col gap-8 w-66.5'>
                    <div className='flex flex-col w-full h-fit bg-white rounded-2xl items-center justify-center gap-4 py-6 shadow-sm'>
                        ...
                        <div className='flex flex-col items-center justify-center'>
                            <span className='font-bold text-[18px] text-[#272e6e] text-center px-2'>
                                {userEmail?.split('@')[0] || 'Suliono Albiantoro'}
                            </span>
                            <span className='text-[10px] text-slate-400 mt-1 uppercase tracking-widest'>
                                NIP: 19900315 201802 1 001
                            </span>
                        </div>
                        <span className='px-4 py-1 bg-[#d9dcf2] text-[#272e6e] text-xs font-bold rounded-full'>
                            Pendidik / Pengajar
                        </span>
                    </div>
